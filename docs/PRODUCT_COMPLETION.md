...
| R-CON | Real-application manual validation coverage (see `docs/target-validation.json` and `docs/FEATURE_MATRIX.md`) — **partial**: chrome/macos + macos_spelling/macos recorded 2026-08-05 (read-only); Firefox + mutation samples still open |
