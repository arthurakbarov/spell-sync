...
| Core orchestration | `spell_sync/sync_run.py`, `spell_sync/push_prepared.py`, `spell_sync/pull.py` | Pull/Push execution after application preview binding |
...
[project-map:start]
_Generated by `scripts/check-architecture.py`; do not edit manually._

| Group | Responsibility |
|-------|----------------|
| `tests.tui` | TUI screens, navigation, wizard, and smoke tests |
| `tests.execution-control` | Timing, admission, evidence, and test selection |
...
| `tests.core` | Domain logic, CLI/JSON, Pull/Push, config, and discovery |
