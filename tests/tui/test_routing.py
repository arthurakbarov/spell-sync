...
from spell_sync.tui.routing import print_non_interactive_usage_error, should_launch_tui
...
class TestCliRouting(unittest.TestCase):
    def test_no_command_non_interactive_exits_2(self):
        with (
    ...
    def test_no_command_tty_launches_ui(self):
        with (
    ...
    def test_ui_json_is_error(self):
        buf = io.StringIO()
        with redirect_stdout(buf):
