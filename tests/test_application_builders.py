...
class TestDashboardBuilders(unittest.TestCase):
    ...
    def test_build_dashboard_issues_includes_git_dirty_and_sublime_override(self):
        ...
        with (
            ...
            patch(
                "spell_sync.application.builders.workspace_git_dirty_message",
                return_value="Personal workspace Git has uncommitted changes (wordlist.txt).",
            ),
            patch(
                "spell_sync.application.builders.enable_sublime",
                return_value=True,
            ),
            patch(
                "spell_sync.application.builders.user_added_words_override_message",
