"""Unit coverage for pull/push application facade paths."""
...
from spell_sync.application.operation_explanations import build_push_target_updates
from spell_sync.application.operation_reports import build_push_operation_report
...
class TestSyncFacadeCoverage(unittest.TestCase):
    def test_build_pull_preview_error_and_skip_statuses(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch(
                "spell_sync.application.push_pull_preview_builders.dictionary_read_result",
    ...
    def test_build_target_updates_and_push_reports(self):
        ...
        self.assertEqual(stopped.title, "Update my apps stopped safely")
        ...
        self.assertEqual(failed.title, "Update my apps failed")
