    ...
    def test_doctor_warns_when_user_overrides(self) -> None:
        with tempfile.TemporaryDirectory() as raw:
            ...
            with patch.object(
                ...
                # user_added_words_override_message uses sublime_packages_dir via default
                with patch(
                    "spell_sync.health.report.user_added_words_override_message",
                    side_effect=lambda: sublime_prefs.user_added_words_override_message(
                        packages_dir=packages,
                    ),
                ):
                    with patch(
                        "spell_sync.health.report.enable_sublime",
                        return_value=True,
                    ):
    ...
    def test_push_hint_warns_on_user_override(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as raw:
            ...
            with (
                ...
                hints_mod.warn_missing_optional_apps(settings=RuntimeSettings.defaults())
