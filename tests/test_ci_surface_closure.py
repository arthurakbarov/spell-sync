"""CI surface checks for public package consistency."""
...
class TestCiSurfaceClosure(unittest.TestCase):
    ...
    def test_mutation_guards_unsafe_artifact_human_message(self) -> None:
        ...
        self.assertIn(".spell-sync.journal.json", message)
