...
class TestReviewSessionHelpers(unittest.TestCase):
    ...
    def test_cleanup_pending_note_does_not_block_match(self):
        from spell_sync.application.product_concepts import RECOVERY_CLEANUP_REMAINING
        ...
        report = build_review_session_report(session, cleanup_pending=True)
        self.assertEqual(report.recovery_note, RECOVERY_CLEANUP_REMAINING)
    ...
    def test_no_changes_with_skipped_apps_is_not_matched(self):
        from types import SimpleNamespace

        from spell_sync.operation_reports import PushPreview
        ...
        preview = PushPreview(
            ...
            additions=0,
            removals=0,
            warnings=("Skipped unreadable: chrome",),
            created_at="2026-01-01T00:00:00+00:00",
        ...
        report = build_review_session_report(session)
        self.assertEqual(report.push_status, "Completed with warnings")
        self.assertFalse(report.is_matched)
