#!/usr/bin/env python3
"""Architecture guards for focused application services."""
...
_FACADE_DELEGATION: dict[str, str] = {
    ...
    "load_extra_word_inventory": "_sync",
    "subtract_extra_words": "_sync",
...
class TestApplicationServiceArchitecture(unittest.TestCase):
    def test_facade_is_thinner_than_previous_monolith(self) -> None:
