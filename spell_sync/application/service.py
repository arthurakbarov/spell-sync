...
from .extra_words import ExtraWordInventory, ExtraWordsWipeResult
from .reports import (
    DashboardState,
    DoctorSnapshot,
...
class SpellSyncService:
    ...
    def load_extra_word_inventory(self, request: StatusRequest) -> ExtraWordInventory:
        return self._sync.load_extra_word_inventory(request)
    ...
    def subtract_extra_words(
        ...
        return self._sync.subtract_extra_words(request, inventory, words)
