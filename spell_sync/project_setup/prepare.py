...
class SetupFileAction(str, Enum):
    CREATE = "create"
    KEEP = "keep"
    CONFLICT = "conflict"
...
def prepare_project_setup(draft: SetupDraft) -> PreparedProjectSetup:
    ...
    config_draft = config_draft_from_targets(draft.selected_targets)
    ...
    if wordlist_path.is_file():
        ...
        conflicts.append("Canonical wordlist does not exist and creation was not requested.")
