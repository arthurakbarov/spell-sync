...
def build_history_record(
    ...
    *,
    ...
    timestamp = ctx.started_at or datetime.now(UTC)
    ...
    if isinstance(source, PullExecution):
    ...
    if isinstance(source, RecoveryExecution):
    ...
    if isinstance(source, ProjectSetupExecution):
    ...
    if isinstance(source, TargetSettingsExecution):
