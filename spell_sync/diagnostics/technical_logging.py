...
def configure_file_logging(paths: AppStatePaths) -> LoggingSetupResult:
    ...
    if _CONFIGURED and _HANDLER is not None and paths.technical_log == _CONFIGURED_LOG:
    ...
    try:
        ...
        return LoggingSetupResult(ok=False, detail="unwritable")
...
def read_technical_log_tail(
    ...
    *,
    ...
    try:
        ...
        return TechnicalLogSnapshot(path=log_path, lines=(), detail="unreadable")
