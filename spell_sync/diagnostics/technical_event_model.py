"""Typed technical event model shared by diagnostics and application layers."""
...
class EventId(str, Enum):
    ...
    # CLI/TUI session bookends (operation_presenter / OperationScreen).
...
type TechnicalEventSink = Callable[[TechnicalEvent], None]
